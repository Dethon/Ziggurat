...
public static class Icons
{
    ...
    // A bolt for the skills page: what it shows is the head start a turn gets.
    public static readonly IconGlyph Bolt = Filled("M7 2v11h3v9l7-12h-4l4-8z");

    // A globe for the web page: what it shows is what the browser met on the way to a page.
    public static readonly IconGlyph Globe = Filled(
