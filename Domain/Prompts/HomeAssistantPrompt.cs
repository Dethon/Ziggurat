...
public static class HomeAssistantPrompt
{
    ...
    // The choosing rule stays with the guide: which mechanism a request is, before any skill is
    // loaded. The doing rules of a watch are claims of the home-watches skill.
